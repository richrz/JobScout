...
1.  **Read Instructions:** You MUST read `.taskmaster/AUDITOR.md` immediately.
...
4.  **Generate Report:** Create `docs/audits/audit-task-[ID].md` using the template in `.taskmaster/AUDITOR.md`.
5.  **Outcome:**
