	...
	theme: {
		extend: {
			...
			colors: {
				...
				// JobScout Prism Theme Colors
				'deep-space': {
					DEFAULT: '#020617', // Slate-950
					light: '#0f172a',   // Slate-900 (Panel Backgrounds)
					lighter: '#1e293b', // Slate-800 (Borders/Hover)
				},
				'electric-green': {
					DEFAULT: '#35e375', // Primary Brand
					dim: '#2d5a3f',    // Muted/Inactive
					glow: 'rgba(53, 227, 117, 0.5)', // Bloom effects
				},
				frost: {
			...
			boxShadow: {
				...
				'neon': '0 0 10px rgba(53, 227, 117, 0.5), 0 0 20px rgba(53, 227, 117, 0.3)',
				'glass': '0 4px 30px rgba(0, 0, 0, 0.1)',
				'glass-inset': 'inset 0 0 20px rgba(255, 255, 255, 0.05)'
			},
			backgroundImage: {
				'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
				'cyber-grid': 'linear-gradient(rgba(53, 227, 117, 0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(53, 227, 117, 0.03) 1px, transparent 1px)',
			},
			keyframes: {
				'accordion-down': {
					from: {
