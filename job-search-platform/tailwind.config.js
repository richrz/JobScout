...
module.exports = {
	...
	theme: {
		extend: {
			fontFamily: {
				sans: ["var(--font-jakarta)", "var(--font-geist-sans)", "ui-sans-serif", "system-ui", "sans-serif"],
			...
			fontSize: {
				'title-page': ['2.25rem', { lineHeight: '2.5rem', letterSpacing: '-0.02em', fontWeight: '700' }],
				'title-section': ['1.5rem', { lineHeight: '2rem', letterSpacing: '-0.01em', fontWeight: '600' }],
			...
			spacing: {
				'page': '2rem',     // 32px (p-8 equivalent)
				'section': '3rem',  // 48px
				'card': '1.5rem',   // 24px (p-6 equivalent)
			},
			boxShadow: {
			...
			keyframes: {
				...
				"pulse-glow": {
					"0%, 100%": { boxShadow: "0 0 0 0px hsla(var(--primary), 0.4)" },
